...
namespace TOAPI.User32
{
    partial class User32
    {
        ...
        //[DllImportAttribute("user32.dll", EntryPoint = "SendInput")]
        //public static extern uint SendInput(uint cInputs,
        ...
        [DllImportAttribute("user32.dll", EntryPoint = "SetCapture")]
        public static extern IntPtr SetCapture(IntPtr hWnd);

        [DllImportAttribute("user32.dll", EntryPoint = "TrackMouseEvent")]
